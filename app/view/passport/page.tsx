...
import {
  ...
  Calendar, AlertTriangle, Eye, ArrowLeft, Code
} from 'lucide-react';
...
export default function PassportViewPage() {
  ...
  if (!webhookData) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <div className="text-2xl font-semibold text-gray-700 mb-4">No passport data found</div>
          <button
            onClick={() => router.back()}
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-8">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold text-gray-900 mb-2">Passport Document</h1>
